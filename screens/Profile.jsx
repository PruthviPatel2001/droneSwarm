                    ...
                    ({handleChange, handleBlur, handleSubmit, values}) =>
                        <>
                            <View className='mx-4 text-left mt-6'>
                                ...
                                <View
                                    className='flex flex-row justify-center items-center w-full border-solid border-b-2 border-gray-200 text-xl'>
                                    <TextInput
                                ...
                                <View
                                    className='flex flex-row justify-center items-center w-full border-solid border-b-2 border-gray-200'>
                                    <TextInput
